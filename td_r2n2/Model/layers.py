...
class FCConv3DLayer_torch(nn.Module):
    ...
    def __init__(self, fc_w_fan_in, filter_shape, output_shape):
        ...
        self.fc_layer = nn.Linear(fc_w_fan_in,
    ...
    def forward(self, fc7, h):
        ...
        out = self.fc_layer(fc7).view(
            *target_shape) + self.conv3d(h) + self.bias
        return out
...
class BN_FCConv3DLayer_torch(nn.Module):
    ...
    def __init__(self, fc_w_fan_in, filter_shape, output_shape):
        ...
        self.bn1 = Recurrent_BatchNorm3d(num_features=filter_shape[0],
                                         T_max=cfg.CONST.N_VIEWS)
        self.bn2 = Recurrent_BatchNorm3d(num_features=filter_shape[0],
                                         T_max=cfg.CONST.N_VIEWS)
